...
const invokeChaincode = async (data) => {
    ...
    try {
        ...
        let invoked = await channel.sendTransactionProposal(chaincodeInvokeRequest, 180000);
        ...
        let broadcastResponse = await channel.sendTransaction(orderer_request, 60000);
