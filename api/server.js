...
// Invoke Chaincode for UploadBinary
import { post_uploadBinary } from './methods/post/post_uploadFile';
app.post('/channels/:channelName/chaincodes/:chaincodeId/binary', post_uploadBinary);
